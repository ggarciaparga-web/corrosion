...
try:
    ...
    with tab3:
        ...
        with col_render:
            ...
            #st.image("https://github.com/user-attachments/assets/36960bd8-5f2d-4faf-961e-e340d4b7f6a8", caption="Referencia de la sección visual",use_container_width=True)
